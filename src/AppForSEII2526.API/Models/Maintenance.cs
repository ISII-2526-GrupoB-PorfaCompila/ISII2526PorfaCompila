namespace AppForSEII2526.API.Models
{
    public class Maintenance
    {
        ...
        public Maintenance(int id, string name, int numberOfDays, double price, IList<BookingItem> bookings, IList<MaintenanceType> maintenanceTypes)
        {
            Id = id;
            Name = name;
        ...
        public Maintenance(int id, string name, int numberOfDays, double price)
        {
            Id = id;
            Name = name;
            NumberOfDays = numberOfDays;
